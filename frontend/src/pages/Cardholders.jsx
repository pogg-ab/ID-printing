...
const Cardholders = () => {
  ...
  const handleOpenModal = (cardholder = null) => {
    if (cardholder) {
      // Fetch card categories for selected cardholder's org first
      handleFormOrgChange(cardholder.organization_id);
      ...
      if (selectedOrgId) {
        handleFormOrgChange(selectedOrgId);
      }
    }
    setIsModalOpen(true);
  };
